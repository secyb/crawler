...
home = 'http://www.cea.gov.cn/publish/dizhenj/464/522/index.html'  # 第一个url
root_url = 'http://www.cea.gov.cn/publish/dizhenj/464/522/index'
url_home =list()  #初始url集合
url_home.append(home)
for index in range(2,43+1):
...
while len(url_home) != 0:
    ...
    #/publish/dizhenj/464/522/20180223145850606465546/index.html
    pattern = '/publish/dizhenj/464/522/\d+/index\.html'
    ...
    while len(url_set) != 0:
        try:
            ...
            # 存储数据
            sql = "INSERT INTO dizhenmedia( title, content ) "
            sql = sql + " VALUES ('%s', '%s') "

        ...
        try:
            ...
            if url not in url_old:
                ...
                if len(tables)!=0:
                    ...
                    # 存储数据
                    sql = "INSERT INTO earthquake( number, magnitude, mercalliscale, datetime1, localtime1, latitude, longtitude, depth, hypocentrum, classtype, continent, country, location, source, potentialimpact ) "
